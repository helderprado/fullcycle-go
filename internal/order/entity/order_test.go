...
import (
	...
	"github.com/helderprado/fullcycle-go/internal/order/entity"
...
func TestGivenAValidParams_WhenCallNewOrder_ThenShouldReceiveOrderWithAllParams(t *testing.T) {
...
func TestGivenANewOrder_ItShouldCalculateFinalPrice_WhenCreateANewOrder(t *testing.T) {
